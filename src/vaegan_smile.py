...
def generator_train_step(batch_size, discriminator, generator, g_optimizer, criterion, labels, num_classes, real_smiles):
    ...
    g_loss = (1 + g_discriminator_loss)*((1 + untranslatable_loss/100)*(1 + g_repeated_loss)/2)*vae_loss
...
if __name__ == "__main__":
    ...
    for pc in params_combinations:    
        ...
        FOLDER_PATH = f"n3_generated_files/{TOKENIZER}/{VOCAB_OPT}/{MIN_DIM}/{GEN_OPT_STR}/lr{LR}_gen{GLRM}_bs{BPE}"
